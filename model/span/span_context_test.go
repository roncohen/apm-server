...
func TestSpanContext(t *testing.T) {
	...
	for idx, te := range tests {
		tctx := &model.TransformContext{Metadata: model.Metadata{Service: te.service}}

		ctx := NewSpanContext(tctx)
...
func TestSpanContextTransform(t *testing.T) {
	...
	for idx, te := range tests {
		// tctx := &model.TransformContext{Metadata: model.Metadata{Service: te.se}}
