...
func TestMetricProcessorOK(t *testing.T) {
	...
	tests.TestProcessRequests(t, beater.MetricV1Route, tctx, requestInfo, map[string]string{})
}

func BenchmarkProcessor(b *testing.B) {
	tctx := &model.TransformContext{}
	tests.BenchmarkProcessRequests(b, beater.MetricV1Route, tctx, requestInfo)
}
